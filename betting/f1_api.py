...
class F1API:
    ...
    def __init__(self):
        ...
        self.session.headers.update({"User-Agent": "F1BettingPool/1.0"})
    ...
    def get_drivers(self, year=2024):
        ...
        try:
            ...
            response = self.session.get(f"{self.base_url}/drivers", params={"session_key": f"{year}_latest"}, timeout=10)
    ...
    def get_race_schedule(self, year=2024):
        ...
        try:
            ...
            response = self.session.get(f"{self.base_url}/sessions", params={"year": year, "session_type": "Race"}, timeout=10)
    ...
    def get_race_results(self, session_key):
        ...
        try:
            response = self.session.get(f"{self.base_url}/position", params={"session_key": session_key}, timeout=10)
    ...
    races = [
        {
            ...
            "country": "Bahrain",
            "date": datetime(2025, 3, 16, 15, 0),
        },
        {
            "name": "Saudi Arabian Grand Prix",
            "location": "Jeddah Corniche Circuit",
            "country": "Saudi Arabia",
            "date": datetime(2025, 3, 23, 17, 0),
        },
        {
            "name": "Australian Grand Prix",
            "location": "Albert Park Circuit",
            "country": "Australia",
            "date": datetime(2025, 4, 6, 15, 0),
        },
        {
            "name": "Japanese Grand Prix",
            "location": "Suzuka Circuit",
            "country": "Japan",
            "date": datetime(2025, 4, 13, 14, 0),
        },
        {
            "name": "Chinese Grand Prix",
            "location": "Shanghai International Circuit",
            "country": "China",
            "date": datetime(2025, 4, 20, 15, 0),
        },
        {
            "name": "Miami Grand Prix",
            "location": "Miami International Autodrome",
            "country": "USA",
            "date": datetime(2025, 5, 4, 15, 30),
        },
        {
            "name": "Emilia Romagna Grand Prix",
            "location": "Autodromo Enzo e Dino Ferrari",
            "country": "Italy",
            "date": datetime(2025, 5, 18, 15, 0),
        },
        {
            "name": "Monaco Grand Prix",
            "location": "Circuit de Monaco",
            "country": "Monaco",
            "date": datetime(2025, 5, 25, 15, 0),
        },
        {
            "name": "Spanish Grand Prix",
            "location": "Circuit de Barcelona-Catalunya",
            "country": "Spain",
            "date": datetime(2025, 6, 1, 15, 0),
        },
        {
        ...
        },
        {
            ...
            "date": datetime(2025, 7, 6, 15, 0),
        },
        {
            "name": "Belgian Grand Prix",
            "location": "Circuit de Spa-Francorchamps",
            "country": "Belgium",
            "date": datetime(2025, 7, 27, 15, 0),
        },
        {"name": "Hungarian Grand Prix", "location": "Hungaroring", "country": "Hungary", "date": datetime(2025, 8, 3, 15, 0)},
        {
            ...
            "country": "Netherlands",
            "date": datetime(2025, 8, 31, 15, 0),
        },
        {
            "name": "Italian Grand Prix",
            "location": "Autodromo Nazionale di Monza",
            "country": "Italy",
            "date": datetime(2025, 9, 7, 15, 0),
        },
        {
            "name": "Azerbaijan Grand Prix",
            "location": "Baku City Circuit",
            "country": "Azerbaijan",
            "date": datetime(2025, 9, 21, 13, 0),
        },
        {
            "name": "Singapore Grand Prix",
            "location": "Marina Bay Street Circuit",
            "country": "Singapore",
            "date": datetime(2025, 10, 5, 14, 0),
        },
        {
            "name": "United States Grand Prix",
            "location": "Circuit of the Americas",
            "country": "USA",
            "date": datetime(2025, 10, 19, 14, 0),
        },
        {
            "name": "Mexico City Grand Prix",
            "location": "Autódromo Hermanos Rodríguez",
            "country": "Mexico",
            "date": datetime(2025, 10, 26, 14, 0),
        },
        {
            "name": "Brazilian Grand Prix",
            "location": "Autódromo José Carlos Pace",
            "country": "Brazil",
            "date": datetime(2025, 11, 9, 14, 0),
        },
        {
            "name": "Las Vegas Grand Prix",
            "location": "Las Vegas Strip Circuit",
            "country": "USA",
            "date": datetime(2025, 11, 22, 22, 0),
        },
        {
            "name": "Qatar Grand Prix",
            "location": "Losail International Circuit",
            "country": "Qatar",
            "date": datetime(2025, 11, 30, 15, 0),
        },
        {
            "name": "Abu Dhabi Grand Prix",
            "location": "Yas Marina Circuit",
            "country": "UAE",
            "date": datetime(2025, 12, 7, 14, 0),
        },
    ]
