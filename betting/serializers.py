...
class DriverSerializer(serializers.ModelSerializer):
    class Meta:
        model = Driver
        fields = ['id', 'first_name', 'last_name', 'driver_number', 'team',
                  'nationality', 'photo', 'is_active']
...
class CompetitionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Competition
        fields = ['id', 'name', 'description', 'year', 'status', 'start_date',
                  'end_date', 'created_by', 'participants_count', 'races_count',
                  'points_for_exact_position', 'points_for_correct_driver', 'created_at']
...
class RaceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Race
        fields = ['id', 'competition', 'competition_name', 'name', 'location',
                  'country', 'round_number', 'race_datetime', 'betting_deadline',
                  'status', 'is_betting_open', 'created_at']
...
class BetTypeSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'name', 'code', 'description', 'is_active',
                  'requires_positions', 'max_selections']
        ...
        for pred in predictions:
            if 'driver' not in pred or 'position' not in pred:
                raise serializers.ValidationError(
                    "Each prediction must have 'driver' and 'position' fields"
                )
...
class RaceResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = RaceResult
        fields = ['id', 'race', 'race_name', 'driver', 'driver_name', 'position',
                  'grid_position', 'fastest_lap', 'did_not_finish', 'dnf_reason',
                  'verified', 'created_at']
...
class CompetitionStandingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'competition', 'competition_name', 'user', 'user_email',
                  'user_display_name', 'total_points', 'rank', 'races_predicted',
                  'exact_predictions', 'partial_predictions', 'updated_at']
...
class RaceDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Race
        fields = ['id', 'competition', 'name', 'location', 'country', 'round_number',
                  'race_datetime', 'betting_deadline', 'status', 'is_betting_open',
                  'results', 'user_bets']
